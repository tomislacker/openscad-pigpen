...
`DARK_H` and `LIGHT_H` must both be whole numbers of layers. The two colours meet
at `z = DARK_H`, and a slicer cannot split a layer: if that plane falls mid-layer
